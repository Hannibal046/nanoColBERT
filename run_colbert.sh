...
python doc2embedding.py --pretrained_model_path wandb/latest-run/files/step-400000 --output_dir embedding/colbert
...
python retrieve.py \ 
    ...
    --output_path ranking.csv

## calculate score
python score.py --qrel_path data/qrels.dev.small.tsv --ranking_path ranking.csv